<?php
define('admin_email','sufyan@ewebcraft.com'); // Change admin email here for example admin@yoursite.com
define('website_name','Medical'); // Change website name here for example yoursite.com
